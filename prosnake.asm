...
.DATA
    ...
    Contador        DB 1							;Esto no deberia de estar
...
main proc far       ; Etiqueta de inicio del Programa					;******NO TIENE LO QUE ES MAIN PROC FAR

;inicializar el Programa

	MOV AX, @DATA    ; Guardando direcci�n de inicio segmento de
    ...
    MOV AX, 0003H               ; Instrucci�n de limpiar la pantalla

    INT 10H                     ; Ejecutar la interrupci�n de video
    ...
    MOV CX, 0000H               ; Posici�n inicial para pintar

    MOV DX, 2555H               ; Ultima posici�n para pintar
    ...
    MOV AH, 09H                 ; Interrupci�n para mostrar texto

    INT 21H



    MOV AH, 07H                 ; Interrupci�n para leer caracer

    INT 21H                     ; Ejecuta la interrupci�n

    MOV AX, 0003H               ; Limpia la pantalla

    INT 10H                     ; Ejecuta la interrupci�n
...
pantallaJuego:
    ...
    CALL posicionarString ;writestringat
...
dibujarArriba:				;BUSCANDOOOOO

    MOV BX, OFFSET Barrera  ; Asigna el limite
...
dibujarAbajo:
    ...
    DEC DL                  ; En este caso decrementa por la posici�n del cursor
...
dibujarIzquierda:
    ...
    RET                     ; Termin� de pintar el mapa

DibujarMapa ENDP



; Coloca un caracter en una posici�n especifica
...
posicionarChar PROC
    ...
    MOV ES:[DI], BL         ; Guarda BL en la posici�n DI de ES
...
; Realiza el movimiento e indica si el jugador perdi�

MoverCulebra PROC

    MOV BX, OFFSET Cabeza       ; Obtiene el simbolo que tendr� la cabeza
...
contenidoMovimiento:
    ...
    JZ FueraLimites             ; La posici�n a la que se movi� est� fuera de los l�mites
...
FueraLimites:
    ...
    ; Se mueve la cabeza y se quita el ultimo segmento, pero si comi� no se quita nada
...
ValidoCabeza:
    ...
    MOV [BX], DX                ; DX guarda la posici�n de la cabeza
    ...
    ; Si no comi� fruta borra el ultimo segmento
...
Delay PROC
    ...
    INT 1AH                     ; Usa la interrupci�n del reloj del sistema
...
; Aca valida si comi� o con que choc�
